...
begin
      ...
      s1:='';
        ...
        s1:=s1+str[i];
        if Form4.LblDescription.canvas.TextWidth(s1)>=Form4.Grpdskr.Width then begin
       ...
       Form4.Lblnose.Caption:=Form4.Lblnose.Caption+'      -     '+qryonepage.FieldByName('Nose').AsString;
       Form4.Lbltail.Caption:=Form4.Lbltail.Caption+'      -     '+qryonepage.FieldByName('Tale').AsString;
       ...
       Form4.Lbldcktp.Caption:=Form4.Lbldcktp.Caption+'      -     '+qryonepage.FieldByName('Type_of_deck').AsString;
       Form4.Lbltrsize.Caption:='  -     '+qryonepage.FieldByName('Tracks_Size').AsString;
       Form4.Lbltrtype.Caption:=Form4.Lbltrtype.Caption+'      -     '+qryonepage.FieldByName('Tracks_Type').AsString;
       Form4.Lblwhhrd.Caption:='   -     '+qryonepage.FieldByName('Wh_Hardness').AsString;
       Form4.Lblwhsize.Caption:='  -     '+qryonepage.FieldByName('Wheel_Size').AsString;
       Form4.Lblbrname.Caption:=Form4.Lblbrname.Caption+'      -     '+qryonepage.FieldByName('Bear_name').AsString;
       Form4.Lblmdof.Caption:=Form4.Lblmdof.Caption+'      -     '+qryonepage.FieldByName('Madeof').AsString;
       Form4.Lblwhlbs.Caption:='      -     '+qryonepage.FieldByName('Wheelbase').AsString;
